...
try:
    ...
    bot_token = '6904017239:AAFWbMgpgNVPYC7NaGAfBJq22gDjZljfPLc'
    DEVLOO = '6330221767'
    MAX_ACCOUNTS = int('30')
    user_bot = 'herhk298bot'
    id_bot = int('6904017239')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6330221767))
